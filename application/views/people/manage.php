...
<div id="title_bar">
    <h1>
        <i class="fa fa-credit-card"></i><?php echo $this->lang->line('common_list_of').' '.$this->lang->line('module_'.$controller_name); ?>
    </h1>
...
<div class="row">    
    ...
    <div class="col-sm-6 float_right btn-group">
        <a class="thickbox none btn btn-danger" title="New Customer" href="<?php echo $controller_name?>/view/-1/width:<?php echo $form_width ?>">
            <?php echo $this->lang->line($controller_name.'_new'); ?>
        </a>
        <?php if ($controller_name =='customers') {?>
            <a class="thickbox none btn btn-danger" title="Import Items from Excel" href="<?php echo $controller_name ?>/excel_import/width:<?php echo $form_width ?>">
                Excel Import
            </a>  
        <?php } ?>
    </div>    
</div>
<!--    <div id="new_button" class="btn btn-primary">
        ...
        <div class="box">
            <div class="box-header">
                <div class="box-name">
                    ...
                    <span><a href="#" id="email" class="btn btn-primary"><?php echo $this->lang->line("common_email");?></a></span>
                </div>
