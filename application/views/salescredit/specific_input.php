...
<div id="page_title" style="margin-bottom:8px;"><?php echo $this->lang->line('salescredit_input'); ?></div>
<?php
if(isset($error))
{
...
$(document).ready(function()
{
	$("#generate_report").click(function()
	{
		...
		else
		{
			...
			window.location = window.location+'/specific_customer/'+start_date + '/'+ end_date + '/' + $('#specific_input_data').val() + '/' + sale_type + '/'+ export_excel;
		}
	});
