...
<div id="title_bar">
    <h1>
        <i class="fa fa-stack-overflow"></i><?php echo $this->lang->line('common_list_of').' '.$this->lang->line('module_'.$controller_name); ?>
    </h1>
...
<div class="row">    
    ...
    <div class="col-sm-6">
        ...
        array('class'=>'thickbox none float_right','title'=>$this->lang->line($controller_name.'_new')));
        ?>
        <?php echo anchor("$controller_name/excel_import/width:$form_width",
        "<div class='btn btn-danger'><span>Excel Import</span></div>",
        array('class'=>'thickbox none float_right','title'=>'Import Items from Excel'));
        ?>
    </div>
</div>
<!--<div id="title_bar">
        ...
        <div class="box">
            <div class="box-header">
                <div class="box-name">
                    ...
                    <span><?php echo anchor("$controller_name/bulk_edit/width:$form_width",$this->lang->line("items_bulk_edit"),array('id'=>'bulk_edit','class' => 'btn btn-primary','title'=>$this->lang->line('items_edit_multiple_items'))); ?></span>
