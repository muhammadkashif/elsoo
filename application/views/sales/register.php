...
<div id="title_bar">
    <h1>
        <i class="fa fa-bolt"></i><?php echo $this->lang->line('sales_register'); ?>
    </h1>
    ...
    <div class="col-md-8">
        <div class="box">
            <div class="box-header">
                <div class="box-name">
<?php
echo anchor("items/view/-1/width:360", "<div class='btn btn-success btn-sm'><span>" . $this->lang->line('sales_new_item') . "</span></div>", array('class' => 'thickbox none', 'title' => $this->lang->line('sales_new_item')));
?>
                    <?php
                    echo anchor("sales/suspended/width:425", "<div class='btn btn-warning btn-sm'><span style='font-size:73%;'>" . $this->lang->line('sales_suspended_sales') . "</span></div>", array('class' => 'thickbox none', 'title' => $this->lang->line('sales_suspended_sales')));
                    ?>
                </div>
                <div class="box-icons">                    
                    <a class="expand-link">
        ...
        <div class="box">
            <div class="box-header">
                <div class="box-name">
                    ...
                    <span><?php echo $this->lang->line('sales_select_customer'); ?></span>
                </div>                
                <div class="no-move"></div>
            </div>            
            <div class="box-content">
                ...
                if (isset($customer)) {
                    ...
                    <div>
                        ...
                        <?php
                        echo anchor("customers/view/-1/width:350", "<div class='small_button' style='margin:0 auto;'><span>" . $this->lang->line('sales_new_customer') . "</span></div>", array('class' => 'thickbox none', 'title' => $this->lang->line('sales_new_customer')));
                        ?>
                    </div>
