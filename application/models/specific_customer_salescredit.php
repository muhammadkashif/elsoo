<?php
require_once("report_salescredit.php");
class Specific_customer_salescredit extends report_salescredit
{
	...
	public function getDataColumns()
	{
		...
		return array('summary' => array($this->lang->line('reports_sale_id'), $this->lang->line('reports_date'), $this->lang->line('reports_items_purchased'), $this->lang->line('reports_sold_by'), $this->lang->line('reports_subtotal'), $this->lang->line('reports_total'), $this->lang->line('reports_payment_type'), $this->lang->line('reports_comments'),$this->lang->line('reports_amount'), $this->lang->line('reports_add')),
					'details' => array($this->lang->line('reports_name'), $this->lang->line('reports_category'),$this->lang->line('reports_serial_number'), $this->lang->line('reports_quantity_purchased'), $this->lang->line('reports_subtotal'), $this->lang->line('reports_total'), $this->lang->line('reports_discount'))
		);
	}
	...
	public function getData(array $inputs)
	{
		...
		$this->db->from('sales_items_temp1');
		...
		elseif ($inputs['sale_type'] == 'Credit Sale')
		{
			$this->db->where("payment_type like 'Credit%'");	
		}
